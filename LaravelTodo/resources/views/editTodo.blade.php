                ...
                <div class="card bg-white rounded border shadow">
                    ...
                    <div class="card-body p-4">
                        ...
                        <form action="/edit" method="POST">
                            @csrf
                            <div class="mb-3">
                                <input type="number" name="todo_id" id="todo_id" value={{$todo->id}} hidden>
                                <label for="title" class="form-label">Title</label>
                                <input type="text" class="form-control" value="{{$todo->title}}" id="title" name="title"
                                placeholder="e.g. Create a C Program" value="" />
                                @error('title')
                            ...
                            <div>
                                <button type="submit" name="addTodo" class="btn btn-primary me-2">Save</button>
